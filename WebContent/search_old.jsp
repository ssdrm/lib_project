	...
	<div id="wrap">
		...
		<div id="form">
			...
			<div id="box">
				<div id="search">
					<ul>
						<li><a class="${cla }" href="LibPServlet?op=okey&cla=m">&nbsp;&nbsp;&nbsp;키워드&nbsp;&nbsp;</a>
						</li>
						<li><a class="${clb }" href="LibPServlet?op=okey&clb=m">&nbsp;&nbsp;전방일치&nbsp;&nbsp;</a>
						</li>
						<li><a class="${clc }" href="LibPServlet?op=okey&clc=m">&nbsp;완전일치&nbsp;
						</a></li>
					</ul>
				</div>
