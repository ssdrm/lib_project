    ...
    <jsp:include page="share/navi.jsp">
        ...
        <OL class="guidetext">
            <li>신청자료의 서지사항(서명, 저자, 출판사)을 정확히 입력한 후, ‘신청’을 클릭하시면 희망자료 신청이
                완료됩니다.</li>
            <LI>자료구입신청 후 신청자료가 어떻게 처리되는지 확인해 보려면 도서관 홈페이지 ‘자료구입신청/조회’에서
                처리상황을 확인할 수 있습니다.</LI>
            <LI>희망도서 신청 제한
                <UL class="guidetext_2depth">
                    <LI>① 신청대상 : 모든 교내 이용자</LI>
                    <p></p>
                    <LI><STRONG>② 신청종수제한<BR> - 1일 : 10종 이내<BR>
                            - 1개월 : 50종 이내
                    </STRONG></LI>
                    <LI>③ 신청 제한 자료 <BR> - 대학도서관에 적합하지 않은 도서(구입이 불가능한 자료 참조) <BR>
                        - 교수는 국내서에 한함 <BR> - 1회 10종이 초과하는 경우는 우선순위(신청순서)에 따라 구입 <BR></LI>
                </UL>
        </OL>
        <H4 class="h4_type2">
