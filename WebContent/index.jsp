		...
		<div id = "navibar">
			...
			<ul>
				<li><a href=""><span>자료검색</span></a>
					<div>
						<ol>
							<li class="first"><a href="search_main.html">통합검색</a></li>
							<li><a href="search_serial.html">연속간행물</a></li>
							<li><a href="search_old.html">고서</a></li>
							<li class="last"><a href="search_theme_main.html">테마가 있는 서재</a></li>
						</ol>
					</div>
				</li>
				...
				<li><a href=""><span>도서관 서비스</span></a> 
					<div>
						<ol>
							<li class="first"><a href="data_intro.html">자료구입신청/조회</a></li>
							<li><a href="borrow_intro.html">대출현황조회/연장</a></li>
							<li class="last"><a href="reserve_intro.html">도서예약</a></li>
						</ol>
					</div>
				</li>
				...
				<li><a href=""><span>도서관 이용안내</span></a>
					<div>
						<ol>
							...
							<li class="last"><a href="come1.html">도서관 오는길</a></li>
						</ol>
					</div>
				</li>
				<li><a href=""><span>마이페이지</span></a>
					<div>
						<ol>
					 		<li class="first"><a href="">개인정보관리</a></li>
							<li><a href="data_application.html">자료구입신청/조회</a></li>
							<li><a href="borrows.html">대출현황조회/연장</a></li>
							<li><a href="">개인연락사항</a></li>
